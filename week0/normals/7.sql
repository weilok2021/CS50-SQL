-- In 7.sql, write a SQL query to find the average ocean surface temperature, rounded to two decimal places,
-- along the equator. Call the resulting column “Average Equator Ocean Surface Temperature”.
